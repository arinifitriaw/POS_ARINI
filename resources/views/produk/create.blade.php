...
<style>
    ...
    .hero-banner-create .text-white-50 {
    ...
    .form-card {
        ...
        box-shadow: 0 10px 30px rgba(51, 65, 85, 0.04);
        overflow: hidden;
    }
...
<div class="container py-4">
    ...
    @if ($errors->any())
        <div class="alert alert-danger border border-danger-subtle shadow-sm rounded-4 mb-4 alert-dismissible fade show">
    ...
    <div class="card form-card mb-4">
        <div class="form-card-header d-flex align-items-center">
            <i class="fa-solid fa-pen-to-square text-secondary me-2 fs-5"></i>
            <h5 class="fw-bold mb-0 fs-6">Formulir Data Produk</h5>
        </div>
